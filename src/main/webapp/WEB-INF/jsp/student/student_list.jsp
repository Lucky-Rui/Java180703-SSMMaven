		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="list-group">
					<a
						href="${ctx}/student/pageList.action"
						class="list-group-item active"> 学生列表 </a> 
					<a
						href="javascript:addStudent()"
				...
				<table class="table table-hover">
					...
					<c:forEach items="${pageBean.list}" var="student">
						<tr>
							...
							<td><a
								href="javascript:updateStudent(${student.id})">
									修改 </a></td>
							<td><a
	...
	<script type="text/javascript">
			...
			$(function() {
				...
				for(var i = 0; i < options.length; i++) {
					if (options[i].value == "${condition.gender}") {
			...
			function addStudent() {
			   ...
			   layer.open({
			     type : 2, // iframe
			     title : "添加学生",
			     area : ["300px", "400px"], // 弹出框的宽和高
			     offset : "100px", //只定义top坐标，水平保持居中
			     content : "${ctx}/student/getAddPage.action"
			   });
			}
			...
			function updateStudent(){
			     ...
			     area : ["300px", "400px"], // 弹出框的宽和高
			     offset : "100px", //只定义top坐标，水平保持居中
			     content : "${ctx}/student/getUpdatePage.action"
			   });
			}
